...
df = pd.read_csv(
    r'C:\Users\Samantha\Box Sync\Wilusz Lab\Test\output_guide-loc.txt', sep='\t')
...
df.to_csv(r'C:\Users\Samantha\Box Sync\Wilusz Lab\Test\output_sorted_guide-loc.txt',
          sep='\t', index=False)

# read in sorted guides that have duplicates removed
df = pd.read_csv(
    r'C:\Users\Samantha\Box Sync\Wilusz Lab\Test\output_sorted_guide-loc.txt', sep='\t')
seq = df["Nucleotide sequence"]
start = df["Start"]
...
df.to_csv(r'C:\Users\Samantha\Box Sync\Wilusz Lab\Test\output_final_guides-loc.txt',
          sep='\t', index=False)
