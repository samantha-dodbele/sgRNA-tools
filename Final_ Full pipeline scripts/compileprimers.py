...
def compileprimers (path):
    ...
    primer.to_csv('C:/Users/Samantha/Box Sync/Wilusz Lab/Data/210316 Twist Library Primer Strategy/210316 CRISPRi sgRNAs/primers.csv', mode='a', header=False, index = False)
